...
def plot(filename):
    ...
    # Pressure
    fig = plt.figure('Pressure coefficient at front side', figsize=(10, 10))
    ...
    v = np.linspace(-0.9, 1.1, 11, endpoint=True)
    xMin = 0.0
    xMax = 0.1
    yMin = 0.0
    yMax = 0.2
    ...
    savefig('Cp_frontSide.png', dpi=1000, bbox_inches='tight')
    savefig('Cp_frontSide.pdf', bbox_inches='tight')
