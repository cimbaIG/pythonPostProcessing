...
plt.savefig('k_subUrban_sampleLine1_homogeneity.png', dpi = 250, bbox_inches = 'tight')
#Show figure
plt.show()
...
figure.set_size_inches(5, 5)
#When saving, specify the DPI
plt.savefig('k_subUrban_sampleLine2_homogeneity.png', dpi = 250, bbox_inches = 'tight')
#Show figure
plt.show()
...
figure.set_size_inches(5, 5)
#When saving, specify the DPI
plt.savefig('k_subUrban_sampleLine3_homogeneity.png', dpi = 250, bbox_inches = 'tight')
#Show figure
plt.show()